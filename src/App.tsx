...
function App() {
  ...
  return (
    <div className="h-screen w-full overflow-y-auto scroll-smooth snap-y snap-mandatory bg-[#000000]">
      ...
      <LandingPage className={`relative ${ width > 600 ? "left-[5%] w-[85%]" : "left-0 w-full" } h-screen bg-transparent snap-start`}/>
      <ExperiencesPage className={`relative ${ width > 600 ? "left-[5%] w-[85%]" : "left-0 w-full" } h-screen bg-transparent snap-start`}/>
